...
<!--				 	<div><a href="./include/forgotpassword.php" style="text-decoration: none; font-size: 12pt; color: blue;">Forgot Password</a></div> -->
		...
		<!-- The notification widget -->
			...
			<div id="right-notification-widget" class="wrapper-column">
				<div id="notification-widget-wrapper">
					<div id="notification-wrapper">
						<div id="notification-banner"><p>Notifications</p></div>
				...
				<div id="happening-now-widget-wrapper">
					<div id="happening-now-wrapper">
						<div id="happening-now-banner"><p>Happening Now</p></div>						

						<div id="happening-now-content-wrapper">
							<div id="happening-now-content"></div>
						</div>
					</div>
				</div>
			</div>
...
<!--				<div class="footer-column">
  ...
  <script src="scripts/jquery-ui-1.8.23.custom.min.js"></script>
    ...
    (function($){
	    ...
	    $("#notification-content-wrapper").mCustomScrollbar({
            	scrollButtons: {
            		enable:true
            	}
            });
